...
elseif($message->{"text"} == 'แสงสว่างห้องทำงาน') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "เปิดไฟห้องทำงานเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿" 
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปิดไฟห้องทำงานเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'แสงสว่างห้องประชุม') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "เปิดไฟห้องประชุมเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปิดไฟห้องประชุมเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'แสงสว่างทั้งหมด') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "เปิดไฟทั้งหมดเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปิดไฟทั้งหมดเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'แอร์ห้องรับแขก') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "เปิดแอร์ห้องรับแขกเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปิดแอร์ห้องรับแขกเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'แอร์ห้องทำงาน') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "เปิดแอร์ห้องทำงานเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปิดแอร์ห้องทำงานเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'แอร์ห้องประชุม') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "เปิดแอร์ห้องประชุมเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปิดแอร์ห้องประชุมเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'แอร์ทั้งหมด') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "เปิดแอร์ทั้งหมดเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปิดแอร์ทั้งหมดเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'ประตูทางเข้า') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ล็อกประตูทางเข้าเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปลดล็อกประตูทางเข้าเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'ประตูห้องทำงาน') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ล็อกประตูทำงานเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปลดล็อกประตูห้องทำงานเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
...
elseif($message->{"text"} == 'ประตูห้องประชุม') {
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปลดล็อกประตูห้องประชุมเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
    ...
    $messageData = [
        'type' => 'text',
        'text' => "ปลดล็อกประตูประชุมเรียบร้อยแล้ว 􀄃􀉕ok hand􏿿"
    ];
    $curl = curl_init();
    curl_setopt_array($curl, array(
    CURLOPT_RETURNTRANSFER => 1,
